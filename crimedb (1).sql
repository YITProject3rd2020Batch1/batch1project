...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 16, 2020 at 03:26 PM
...
INSERT INTO `complaint` (`com_id`, `com_type`, `date`, `victim_det`, `location`, `det_com`, `asgd_po`, `adm_rmk`, `usr_rmk`, `status`, `email`) VALUES
(2, 'Robbery', '2020-05-20', 'hgjf', 'ghdfv', 'eghf', 'hbkb', 'hhhbhnjk', 'hgvhjg', 'pending', 'hb'),
(57, 'Robbery', '2020-02-25', 'jnvj v', ' ncn mn', 'nf ', 'jshadgf', 'hsdfb', 'hbg ', 'closed', ''),
(88, 'Robbery', '1999-02-22', 'bc hjbcv', 'hfjnvjfhv', 'jhfvny', 'm ', 'jdnjd', 'ehfv', 'pending', ''),
...
('raghav', 'cc', '123', 'hfbgbf', '9876543211', 'female', 'mother\'s name', 'ghv', 'user'),
...
('gsdh', 'gdv', '123', 'hbfcjhb', '9876543211', 'female', 'mother\'s name', 'hbjn', 'user'),
('fcg', 'jnjkn', '123', 'hbhb', '9876543211', 'female', 'mother\'s name', 'gvghgb', 'user'),
...
('rep_9998', '2020-06-10', 'on may-05-2020 the builder namely varun, a ceo of varun builders was found to be building the bar in government land which was supposed to be a agricultural land. they have provided the RTC in which they have mentioned government land hs been belogs to the varun. enquiring village people for the further details and waiting for the cooperation.', 'Police officer', 0);
